...
import net.mcreator.chatencryption.init.ChatencryptionModProcedures;
...
public class ChatencryptionMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(ChatencryptionMod.class);
	public static final String MODID = "chatencryption";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing ChatencryptionMod");
		ChatencryptionModProcedures.load();
		tick();
